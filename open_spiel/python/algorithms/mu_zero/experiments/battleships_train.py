...
parser.add_argument("--iterations", type=int, default=120, help="MuZero network training iterations,  the whole algorithm will run for --iterations * --save_each")
...
parser.add_argument("--transformation_soft_k_means_temperature", type=float, default=5.0, help="Transformation soft k means temperature")
...
parser.add_argument("--seed", type=int, default=7777, help="Random seed, use 0 to have totally random seed")
