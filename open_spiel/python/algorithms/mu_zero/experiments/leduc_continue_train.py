...
from open_spiel.python.algorithms.mu_zero.mu_zero_train import MuZeroTrainConfig


parser = argparse.ArgumentParser()

# Training setting
parser.add_argument("--model_path", type=str, default="muzero_networks/leduc/seed_123456/muzero_5.pkl", help="Model path") 
...
def main(): 
  ...
  folder = args.save_folder + "/leduc/" + "seed_" + str(model.config.seed) + "/"# + "no_rnad_train/"
