...
parser.add_argument("--abstraction_hard_k_means_closeness", type=float, default=0.25, help="Abstraction hard k means closeness")
...
# Game setting
parser.add_argument("--board_size", type=int, default=7, help="Size of the board (must be odd)")
parser.add_argument("--initial_coins", type=int, default=5, help="Number of coins each player starts with")
...
def main(): 
  ...
  game = JaxOshiZumo(args.board_size, args.initial_coins)
  folder = args.save_folder + "/oshi_zumo_" + str(args.board_size) + "_" + str(args.initial_coins) + "/" + "seed_" + str(args.seed) + "/"
